<template>
    <div>
        <div class="page-header">
            ...
            <p>Edit the newsletter signup section</p>
        </div>
        <div class="form-card">
            <form @submit.prevent="save">
                ...
                <div class="form-row">
                    <div class="form-group">
                        <label>Icon (class)</label><input v-model="form.icon" />
                    </div>
                    <div class="form-group">
                        <label>Placeholder</label
                        ><input v-model="form.placeholder" />
                    </div>
                </div>
                <div class="form-group">
...
async function save() {
    ...
    saving.value = true;
    try {
        await api.put("/newsletter-section", form.value);
    } catch (e) {
