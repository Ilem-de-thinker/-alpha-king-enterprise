...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'posts/:id/edit', name: 'PostEdit', component: () => import('@/views/admin/posts/PostFormView.vue') },
  ...
  { path: '/about.html', name: 'About', component: () => import('@/views/public/AboutView.vue') },
  { path: '/services.html', name: 'Services', component: () => import('@/views/public/ServicesView.vue') },
  { path: '/contact.html', name: 'Contact', component: () => import('@/views/public/ContactView.vue') },
  { path: '/post.html', name: 'Blog', component: () => import('@/views/public/BlogView.vue') },
  { path: '/single-post.html', name: 'SinglePost', component: () => import('@/views/public/SinglePostView.vue') },
