  ...
  <div>
    ...
    <template v-if="loading">
      <section class="ve-page-hero" style="background-image:url(/img/bg-img/3.jpg);">
        ...
        <div class="container ve-page-hero-content">
          <ul class="ve-breadcrumb"><li><router-link to="/">Home</router-link></li><li><router-link to="/blog">Insights</router-link></li><li class="active">...</li></ul>
          <h1>Loading...</h1>
        </div>
      </section>
    ...
    <template v-else>
      <section class="ve-page-hero" :style="{ backgroundImage: 'url(' + (post.featuredImage || '/img/bg-img/3.jpg') + ')' }">
        <div class="ve-page-hero-overlay"></div>
        <div class="container ve-page-hero-content">
          <ul class="ve-breadcrumb"><li><router-link to="/">Home</router-link></li><li><router-link to="/blog">Insights</router-link></li><li class="active">{{ post.title }}</li></ul>
          <h1>{{ post.title }}</h1>
            ...
            <div class="col-12 col-lg-4">
              <aside class="ve-sidebar">
                <div class="ve-sidebar-widget">
                  ...
                  <ul class="ve-cat-list">
                    <li v-for="c in categories" :key="c.id">
                      <router-link :to="{ path: '/blog', query: { category: c.name } }">{{ c.name }} <span>{{ c.postCount }}</span></router-link>
                    </li>
                  </ul>
                </div>
                <div class="ve-sidebar-widget">
                ...
                <div class="ve-sidebar-widget">
                  ...
                  <div class="ve-tags">
                    <router-link v-for="t in tags" :key="t.id" :to="{ path: '/blog', query: { tag: t.name } }">{{ t.name }}</router-link>
                  </div>
                </div>
              </aside>
            </div>
