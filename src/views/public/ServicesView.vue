  ...
  <div>
    ...
    <template v-if="loading">
      ...
      <div class="container" style="padding:40px 0;">
        <SkeletonLoader type="process-steps" :count="4" />
      </div>
      <div class="container" style="padding:40px 0;">
        ...
        <div class="container">
          ...
          <div class="ve-services-grid">
            <div class="ve-service-card" v-for="s in services" :key="s.id">
              ...
              <h4>{{ s.title }}</h4>
              <p>{{ s.description }}</p>
              <router-link to="/contact" class="ve-card-link">Get Started <i class="fa fa-long-arrow-right"></i></router-link>
            </div>
          </div>
        </div>
      </section>
        ...
        <div class="container ve-cta-content">
          <div class="row align-items-center">
            ...
            <div class="col-12 col-lg-4 text-lg-right">
              <router-link to="/contact" class="ve-btn-white">Start Your Project</router-link>
            </div>
          </div>
        </div>
      </section>
