(function(global, factory) {
	...
	*/
	...
	//#endregion
	//#region src/utils/isClassicEditor.ts
	function isClassicEditor(Editor) {
		return !Editor.editorName || Editor.editorName === "ClassicEditor";
	}
	//#endregion
	//#region src/composables/useEditorElementDefinition.ts
	/**
	* @license Copyright (c) 2003-2026, CKSource Holding sp. z o.o. All rights reserved.
	* For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-licensing-options
	*/
	...
	*/
	function useEditorElementDefinition({ Editor, config, defaultElementName }) {
		return (0, vue.computed)(() => {
			const _config = (0, vue.toValue)(config);
			if (!isClassicEditor((0, vue.toValue)(Editor))) {
				var _config$roots$main$el, _config$roots, _config$root;
				const customElementDefinition = (_config$roots$main$el = (_config$roots = _config.roots) === null || _config$roots === void 0 || (_config$roots = _config$roots.main) === null || _config$roots === void 0 ? void 0 : _config$roots.element) !== null && _config$roots$main$el !== void 0 ? _config$roots$main$el : (_config$root = _config.root) === null || _config$root === void 0 ? void 0 : _config$root.element;
				if (customElementDefinition) return customElementDefinition;
			}
			return (0, vue.toValue)(defaultElementName);
		});
	}
	//#endregion
	//#region src/utils/normalizeEditorElementDefinition.ts
	/**
	* @license Copyright (c) 2003-2026, CKSource Holding sp. z o.o. All rights reserved.
	* For licensing, see LICENSE.md or https://ckeditor.com/legal/ckeditor-licensing-options
	*/
	...
	*/
	function normalizeEditorElementDefinition(definition) {
		if (typeof HTMLElement !== "undefined" && definition instanceof HTMLElement) throw new Error("An HTMLElement cannot be used as an editor element definition. Please pass a string or an object definition.");
		if (typeof definition !== "object" || definition === null) return { name: definition };
		return definition;
	}
	//#endregion
	//#region src/EditorElement.vue
	var EditorElement_default = /* @__PURE__ */ (0, vue.defineComponent)({
		__name: "EditorElement",
		props: { definition: { default: null } },
		setup(__props, { expose: __expose }) {
			const props = __props;
			const elementRef = (0, vue.ref)();
			__expose({ elementRef });
			const definition = (0, vue.computed)(() => {
				var _props$definition;
				return normalizeEditorElementDefinition((_props$definition = props.definition) !== null && _props$definition !== void 0 ? _props$definition : "div");
			});
			return (_ctx, _cache) => {
				return (0, vue.openBlock)(), (0, vue.createBlock)((0, vue.resolveDynamicComponent)(definition.value.name), (0, vue.mergeProps)({
					ref_key: "elementRef",
					ref: elementRef
				}, definition.value.attributes, {
					class: definition.value.classes,
					style: definition.value.styles
				}), null, 16, ["class", "style"]);
			};
		}
	});
	...
	var ckeditor_default = /* @__PURE__ */ (0, vue.defineComponent)({
		...
		setup(__props, { expose: __expose, emit: __emit }) {
			...
			const editorElementRef = (0, vue.ref)();
			...
			(0, vue.onMounted)(async () => {
				...
				try {
					var _editorElementRef$val;
					const domElement = (_editorElementRef$val = editorElementRef.value) === null || _editorElementRef$val === void 0 ? void 0 : _editorElementRef$val.elementRef;
					if (!domElement) throw new Error("Editor element is not available. Make sure the component is mounted.");
					const editor = await (supports.elementConfigAttachment ? Constructor.create((0, _ckeditor_ckeditor5_integrations_common.assignElementToEditorConfig)(Constructor, domElement, editorConfig)) : Constructor.create(domElement, editorConfig));
					...
					if (watchdog) {
						...
						watchdog.on("restart", () => {
							try {
								if (instance.value && isClassicEditor(Constructor)) cleanupOrphanEditorElements(instance.value);
							} catch (err) {
								console.error(err);
							}
							if (!isUnmounted.value) {
			...
			return (_ctx, _cache) => {
				return (0, vue.openBlock)(), (0, vue.createBlock)(EditorElement_default, {
					ref_key: "editorElementRef",
					ref: editorElementRef,
					definition: (0, vue.unref)(elementDefinition)
				}, null, 8, ["definition"]);
			};
		}
	});
