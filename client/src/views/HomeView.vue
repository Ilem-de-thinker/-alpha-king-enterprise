          ...
          <div class="col-12 col-lg-7">
            <div class="ve-whyus-content">
              ...
              <div class="ve-checklist">
                <div class="ve-check-item" v-for="c in whyUsChecklist" :key="c.id">
...
onMounted(async () => {
  try {
    ...
    whyUsChecklist.value = Array.isArray(checklistRes.data) ? checklistRes.data : []
